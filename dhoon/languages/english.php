...
$LNG['email'] = 'Email';
$LNG['captcha'] = 'Captcha';
$LNG['username_or_email'] = 'Username';
...
$LNG['user_not_verified'] = 'Account is not verified yet. Please check your mail box for account verification e-mail.';
...
$LNG['user_created'] = 'Thank you for joining <strong>%s</strong><br /><br />Your username: <strong>%s</strong><br />Your Password: <strong>%s</strong><br /><br />You can log-in at: <a href="%s" target="_blank">%s</a>'.'<br /><br /><strong>Use the bellow link to verify your account:</strong><br /><a herf="%s" target="_blank">%s</a>'.$LNG['email_footer_gen'];
...
$LNG['0_upload_err'] = 'Your account has exceeded the total upload size allowed';
$LNG['1_upload_err'] = 'No track selected';
$LNG['2_upload_err'] = 'The selected track is too big. Allowed max. file size is %s';
$LNG['3_upload_err'] = 'The selected track does not have a valid format. Upload an %s audio file type';
...
$LNG['blocked_desc'] = 'Blocked persons can no longer contact your trough messages.';
...
$LNG['admin_menu_pick_of_day'] 		= $LNG['admin_ttl_pick_of_day']	= 'Picks of the Day';
